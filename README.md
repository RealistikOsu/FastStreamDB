...
| `payload_size` | The size (in bytes) of the payload directly following this. | 4 | `u32` |
...
- `CLIENT_REQUEST_STREAM_CONTENTS` and `CLIENT_REQUEST_STREAM_CONTENTS_NO_CLEAR` and `CLIENT_CHECK_STREAM_STATE`
| Name | Description | Size (bytes) | Data Type |
| ---- | ----------- | ------------ | --------- |
